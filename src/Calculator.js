        ...
        <div className="Calculator">
            ...
            <div className="content">
                ...
                <details open> {/* place "open" next to "details" to make it open on load */}
                    ...
                    <div className="Vert-flex">
                        <div>
                            <English>{energyGenerated ? `Energy generated by solar sytem: ${energyGenerated} kWh per month` : ""}</English>
                            <Albanian>{energyGenerated ? `Energjia e gjeneruar nga sistemi diellor: ${energyGenerated} kWh në muaj` : ""}</Albanian>
                        </div>
                        <div>
