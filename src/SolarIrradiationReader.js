 ...
 * @param {*} month The month to get data for. Must be one of the strings in timeOptions. AVG returns the overall average accross all months
 * @param {*} capacity The capacity of solar panel being calculated for in kW/m^2. Important for converting from (kWh/month)/m^2 to (kWh/month)/kW.
 * @param {*} isLeapYear Whether the year is a leap year. The default is false, and only matters for calculations for February
